...
<body>
            ...
            ?>
                ...
                ?>-->
                    ...
                    <td>
                        ...
                        ?>
                            <a href="ubah_status_paket.php?id_transaksi=<?= $dt_histori['id_transaksi'] ?>&status_order=selesai"><button class="btn btn-primary">Proses Selesai</button></a>
                        <?php
    ...
    <a href="cetak.php" onclick="window.print()" class="btn btn-secondary"> cetak data</a>
